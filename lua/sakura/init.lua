...
local function highlights(palette)
    ...
    return {
        ...
        luasnip = {
            ...
            LuasnipChoiceNodeVisited = { sp = palette.yellow, underdashed = true, },
            LuasnipChoiceNodeVisitedVirtualText = { fg = palette.yellow, },
            ...
            LuasnipInsertNodeVisited = { sp = palette.cyan, underdashed = true, },
            LuasnipInsertNodeVisitedVirtualText = { fg = palette.cyan, },
        },
        neotree = {
