...
local function highlights(palette)
    ...
    return {
        ...
        dap_ui = {
            ...
            DapUIUnavailable = { fg = palette.subtle, },
        ...
        statusline = {
            StatusLine                     = { fg = palette.text, bg = palette.base, },
            ...
            StatusLineDivider              = { fg = palette.subtle, },
