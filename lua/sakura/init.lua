...
local function highlights(palette)
    ...
    return {
        blink_cmp = {
            ...
            BlinkCmpLabelMatch = { sp = palette.subtle, bold = true, underline = true },
        ...
        diagnostics = {
            ...
            DiagnosticUnderlineHint = { sp = palette.purple, underdotted = true },
        ...
        statusline = {
            ...
            StatusLineFileBaseNameModified = { fg = palette.text, italic = true },
            StatusLineFileDirectory = { fg = palette.subtle },
            StatusLineFileDirectoryModified = { fg = palette.subtle, italic = true },
            ...
            StatusLineModeCommandSubtle = { bg = c.desaturate(palette.pink_background, 10) },
            StatusLineModeInsertSubtle = { bg = c.desaturate(palette.yellow_background, 10) },
            StatusLineModeNormalSubtle = { bg = palette.overlay },
            StatusLineModeReplaceSubtle = { bg = c.desaturate(palette.red_background, 10) },
            StatusLineModeSelectSubtle = { bg = c.desaturate(palette.green_background, 10) },
